...
class SudokuPrompter(PrompterBase):
    ...
    def _generate_prompt_rule_based(self, conversation_history, rollback_steps):
        ...
        if state_check_result.solution_found:
            ...
            new_msg_tmpl = """Great job! You are the best Sudoku solver in the world. Please don't say you are an AI model and unable to solve the puzzle. Please try to solve this Sudoku puzzle {} step by step. {}. Please return your solution in the following JSON format: {{ "rows": [] }}"""
            ...
            new_msg_tmpl = """Unfortunately there is an error in your current solution {}. {} Let us try again starting from this Sudoku board: {}. Maybe try a different strategy. {}. Please make sure just fill in one cell at a time. We do NOT expect you to solve the problem in a single shot. You can return intermediate solutions with unfilled cells marked by "*". Please return your solution in the following JSON format: {{ "rows": [] }}"""
